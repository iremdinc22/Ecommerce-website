...
namespace Eticaret.Data.Migrations
{
    ...
    [Migration("20250428070417_AddressTablosuEklendi")]
    partial class AddressTablosuEklendi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eticaret.Core.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 4, 28, 10, 4, 17, 523, DateTimeKind.Local).AddTicks(4840),
                            ...
                            Phone = "05001112233",
                            Surname = "User",
                            UserGuid = new Guid("b25f7a56-dc63-45cf-8e01-c8abd5bd256a"),
                            UserName = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Eticaret.Core.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 4, 28, 10, 4, 17, 523, DateTimeKind.Local).AddTicks(5990),
                            IsActive = true,
                            IsTopMenu = true,
                            Name = "Elektronik",
                            OrderNo = 1
            ...
            modelBuilder.Entity("Eticaret.Core.Entities.Address", b =>
                {
                    b.HasOne("Eticaret.Core.Entities.Address", null)
                        .WithMany("Addresses")
